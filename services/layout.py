...
def get_layout(type:str):
    ...
    'corriente_dc': {'start_row': 91, 'step': 2, 'mid_row': 97, 'after_mid': 102,'normal_point':[0.1,0.9],'mid_point':[0.1,0.3,0.5,0.7,0.9],'final_row':107},
    'corriente_ac': {'start_row': 113, 'step': 2, 'mid_row': 119, 'after_mid': 124,'normal_point':[0.1,0.9],'mid_point':[0.1,0.3,0.5,0.7,0.9],'final_row':129},
    ...
    if "multimetro" in type:
        MULTI_LAYOUT={
            ...
            'resistencias': {'start_row': 131, 'step': 2,'normal_point':[0.1,0.9],'final_row':148}
        }
